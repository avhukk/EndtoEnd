...
class DataTransformation: 
    ...
    def get_data_transformation_object(self): 
        try: 
            ...
            # Defining which columns be ordinally encoded and which should be scaled
            ...
            ## Numerical Pipeline
            # Filling missing data with Median values using imputer
            ...
            return preprocessor # Apparently, the pickle file
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try: 
            ...
            logging.info("Exception occured in the the initiate_data_transformation section")
